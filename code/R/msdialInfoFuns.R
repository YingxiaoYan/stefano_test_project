...
#@rdname This tells roxygen2 that the documentation for this function belongs to the same help page as another function whose “R documentation name” is getShinyFileName.
#alias This tells roxygen that the function should also be searchable under the alias getShinyFileName.
